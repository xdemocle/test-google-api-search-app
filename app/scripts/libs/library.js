    ...
    DomObject.prototype = {
      ...
      find: function(selector) {
        ...
        if (selector.split(' ').length > 1) {
          ...
          if (Obj && typeof Obj.item === 'function') {
            ...
            elements.push( context[0].getElementsByClassName(target) );

          } else {

            elements = context.getElementsByClassName(target);
          }

        } else if (type === '#') {

          elements.push( context.getElementById(target) );
        ...
        // If elements is an object, convert in Array
        if (Obj && typeof Obj.item === 'function') {

          elements = elements && Array.prototype.slice.call(elements);
        }
      ...
      is: function(value) {
        ...
        if (typeof value === 'string') {
          ...
          if (target === '#') {
            ...
            var arr = Array.prototype.slice.call(this.el.classList);
      ...
      remove: function() {
        ...
        if (typeof this.el !== 'string' && this.el.length > 1) {
          ...
          var elements = Array.prototype.slice.call(this.el);
